...
export default function Navbar() {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="/"><img src='favicon.ico' alt='#'></img>GryfLive</a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            ...
            <li><a className="dropdown-item" href="/">Music & Dance</a></li>
      ...
      <button className="btn btn-outline-success mx-2 d-flex" type="submit">Go Live</button>      

      <button type="button" className="btn btn-success mx-2 d-flex">Sign in</button>
    </div>
  </div>
</nav>
    </div>
